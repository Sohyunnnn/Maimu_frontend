  ...
  return (
    ...
    >
      ...
      >
        ...
        <SwiperSlide className="Swiper">
          <div className="SwiperContainer">
          <div className="WhatFlavor_T SwiperTitle">MAIMU는 무슨 맛이 있나요?</div>
          <div className="WhatFlavor_C1 SwiperContent">친구가 나에게 주고 싶은...</div>
          ...
          <div className="WhoMade_T1 SwiperTitle">누가 만든 서비스인가요?</div>
          <a className="SwiperTitle" href="https://www.instagram.com/maimu.official/?igsh=cm1lYWhuNTB4eTY2&utm_source=qr">@maimu.official</a>
          <div className="WhoMade_C SwiperContent">
            <ul>
              <li>
                MAIMU는 홍익대, 이화여대, 고려대, 세종대,
                 서울여대 학생 8명으로 구성된 대학생 팀
